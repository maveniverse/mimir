...
File daemon1LockDir = new File(basedir, 'mimir1/daemon/')
assert !daemon1LockDir.exists()
File daemon2LockDir = new File(basedir, 'mimir2/daemon/')
assert !daemon2LockDir.exists()
